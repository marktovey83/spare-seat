window.SEED = {
  suburbs: [
    ...
    { id: 'bunbury', name: 'Bunbury', lat: -33.327, lng: 115.637 },
    { id: 'maroochydore', name: 'Maroochydore', lat: -26.655, lng: 153.094 },
    { id: 'brisbane', name: 'Brisbane', lat: -27.4705, lng: 153.026 },
    { id: 'mackay', name: 'Mackay', lat: -21.141, lng: 149.186 }
  ],
  patches: [
    { id: 'perth-sw', name: 'Perth south-west', partner: 'Partner 1', lat: -32.12, lng: 115.76, km: 10 },
    { id: 'seq', name: 'Sunshine Coast / Brisbane', partner: 'Partner 2', lat: -27.0, lng: 153.06, km: 10, extra: [{ name: 'Brisbane', lat: -27.4705, lng: 153.026 }, { name: 'Maroochydore', lat: -26.655, lng: 153.094 }] },
    { id: 'mackay', name: 'Mackay', partner: 'Partner 3', lat: -21.141, lng: 149.186, km: 10 }
  ],
  ...
  venues: [
    ...
    { id: 'v2', name: 'Local', suburb: 'south', lat: -32.068, lng: 115.752, showing: ['f1'], deal: 'Jug every 3', seats: 6, pin: '4821', patch: 'perth-sw' },
    { id: 'v3', name: 'Club', suburb: 'cottesloe', lat: -31.996, lng: 115.755, showing: ['f1', 'f2'], deal: 'Seats held', seats: 10, pin: '4821', patch: 'perth-sw' },
    { id: 'v4', name: 'North End Arms', suburb: 'joondalup', lat: -31.744, lng: 115.768, showing: ['f2', 'f4'], deal: 'Breakfast NFL', seats: 12, pin: '4821', patch: 'perth-sw' },
    { id: 'v5', name: 'South West Arms', suburb: 'mandurah', lat: -32.530, lng: 115.742, showing: ['f1', 'f3'], deal: 'Jug every 3', seats: 10, pin: '4821', patch: 'perth-sw', target: true },
    { id: 'v6', name: 'Bunbury Screen', suburb: 'bunbury', lat: -33.325, lng: 115.640, showing: ['f1'], deal: 'Held table', seats: 8, pin: '4821', patch: 'perth-sw', target: true },
    { id: 'v7', name: 'Coast Hotel', suburb: 'maroochydore', lat: -26.658, lng: 153.090, showing: ['f2', 'f3'], deal: 'NRL + platter', seats: 12, pin: '4821', patch: 'seq', target: true },
    { id: 'v8', name: 'River Pub', suburb: 'brisbane', lat: -27.468, lng: 153.028, showing: ['f2', 'f1'], deal: 'Seats held', seats: 14, pin: '4821', patch: 'seq', target: true },
    { id: 'v9', name: 'Harbour Club', suburb: 'mackay', lat: -21.143, lng: 149.184, showing: ['f2', 'f3'], deal: 'NRL + cricket', seats: 10, pin: '4821', patch: 'mackay', target: true }
  ],
  people: [
