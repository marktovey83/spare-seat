(function () {
  ...
  function inject() {
    ...
    const tabOn = [...document.querySelectorAll("#nav-punter button")].some((b) => (b.dataset.tab === "chats" || b.dataset.tab === "friends") && b.classList.contains("active"));
    if (!tabOn) return;
    ...
    if (!el) {
      ...
      el.className = "chat-map " + (plus ? "plus" : "free");
